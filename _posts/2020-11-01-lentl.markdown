...
Getting a better sense of the navigation, my collaborator drew some sketches to give me an idea of the app navigation and the product features we wanted to implement.
